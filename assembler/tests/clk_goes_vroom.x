...
lw x7 x18 0                         # get current month from ram in x7
lw x5 x17 0                         # get current day from ram in x5
...
MAIN_LOOP:
addi x13 x13 1                      # update the seconds
...
addi x5 x5 1                        # nb_days +1
blt x5 x29 x5 CHECK_MODULOS_MTH     # if 31 < nb_days check the month
jal x5 MAIN_LOOP

CHECK_MODULOS_MTH:
addi x5 x27 1                       # nb_days = 1
addi x7 x7 1                        # nb_month +1
blt x7 x28 x7 CHECK_MODULOS_YRS     # if 12 < nb_month check the year
jal x7 MAIN_LOOP

CHECK_MODULOS_YRS:
addi x7 x27 1                       # nb_month = 1
